...
type TransformBefore<T extends Parameters = Parameters> = (data: T) => any;
type TransformAfter<T extends Parameters = Parameters> = (data: any) => Promise<Partial<T>>;

type ExtensionAPI<T extends Parameters = Parameters> = {
