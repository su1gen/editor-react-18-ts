...
export var findMediaSingleNode = function findMediaSingleNode(mediaPluginState, id) {
...
export var findMediaInlineNode = function findMediaInlineNode(mediaPluginState, id, isMediaSingle) {
  if (!isMediaSingle) {
...
export var findAllMediaSingleNodes = function findAllMediaSingleNodes(mediaPluginState, id) {
...
export var findMediaNode = function findMediaNode(mediaPluginState, id, isMediaSingle) {
