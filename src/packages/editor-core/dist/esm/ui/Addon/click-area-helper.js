...
var clickAreaClickHandler = function clickAreaClickHandler(view, event) {
  ...
  var isPopupClicked = !!closestElement(target, '[data-editor-popup]'); // Fixes issue when using a textarea for editor title in full page editor doesn't let user focus it.
