...
export default {
  ...
  'fabric.editor.extension.confirmDeleteLinkedModalMessage': 'При удалении этого расширения нарушится работа всего, что с ним связано.',
  'fabric.editor.extension.confirmDeleteLinkedModalOKButton': 'Удалить расширение',
  ...
  'fabric.editor.searchResults': '{itemsLength, plural, one {Доступен {itemsLength,number} результат поиска} few {Доступно {itemsLength,number} результата поиска} many {Доступно {itemsLength,number} результатов поиска} other {Доступно {itemsLength,number} результата поиска}}',
