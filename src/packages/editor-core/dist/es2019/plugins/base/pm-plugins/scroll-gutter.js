    ...
    view(view) {
      ...
      return {
        ...
        update(view, prevState) {
          ...
          const mobileDimensionsPluginState = getMobileDimensionsPluginState(state);
          const viewportHeight = scrollElement.offsetHeight - (mobileDimensionsPluginState && mobileDimensionsPluginState.keyboardHeight ? mobileDimensionsPluginState.keyboardHeight : 0);
          const contentHeight = editorParentElement.offsetHeight - (gutterMounted ? gutterSize : 0); // Add or remove the gutter based on whether the content is about to exceed the viewport height.
