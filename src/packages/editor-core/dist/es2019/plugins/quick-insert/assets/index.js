...
export const IconAction = Loadable({
  ...
  './action').then(module => module.default),
  loading: () => null
});
...
export const IconQuote = Loadable({
  ...
  './quote').then(module => module.default),
  loading: () => null
});
...
export const IconFallback = Loadable({
  ...
  './fallback').then(module => module.default),
  loading: () => null
});
