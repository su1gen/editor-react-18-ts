...
var handleResolved = function handleResolved(view, request, options) {
  return function (resolvedCard) {
    ...
    (0, _doc.replaceQueuedUrlWithCard)(request.url, resolvedCard, request.analyticsAction)(view.state, view.dispatch);
    return resolvedCard;
  };
};
...
var handleRejected = function handleRejected(view, request) {
  return function () {
    (0, _doc.handleFallbackWithAnalytics)(request.url, request.source)(view.state, view.dispatch);
  };
