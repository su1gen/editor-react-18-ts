...
var getSelectionForMatch = function getSelectionForMatch(selection, doc, index, matches) {
  ...
  if (matches[index]) {
    return _prosemirrorState.TextSelection.create(doc, matches[index].start + offset);
  }

  return selection;
};

exports.getSelectionForMatch = getSelectionForMatch;
...
exports.findDecorationFromMatch = findDecorationFromMatch;
...
exports.removeDecorationsFromSet = removeDecorationsFromSet;
...
exports.removeMatchesFromSet = removeMatchesFromSet;
...
exports.findLostAdjacentDecorations = findLostAdjacentDecorations;
...
exports.findIndexBeforePosition = findIndexBeforePosition;
