...
function convertListType(_ref) {
  ...
  if (tr.selection instanceof _gapCursorSelection.GapCursorSelection) {
...
var convertSelectedList = function convertSelectedList(_ref2) {
  ...
  if (selection instanceof _prosemirrorState.TextSelection && selection.$cursor || selection instanceof _gapCursorSelection.GapCursorSelection) {
