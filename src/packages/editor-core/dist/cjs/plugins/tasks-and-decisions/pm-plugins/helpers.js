...
exports.walkOut = exports.subtreeHeight = exports.liftBlock = exports.isTable = exports.isInsideTaskOrDecisionItem = exports.isInsideTask = exports.isInsideDecision = exports.isEmptyTaskDecision = exports.isActionOrDecisionList = exports.isActionOrDecisionItem = exports.getTaskItemIndex = exports.getCurrentIndentLevel = exports.getBlockRange = void 0;
...
var isInsideTaskOrDecisionItem = function isInsideTaskOrDecisionItem(state) {
  ...
  return (0, _prosemirrorUtils.hasParentNodeOfType)([decisionItem, taskItem])(state.selection);
};

exports.isInsideTaskOrDecisionItem = isInsideTaskOrDecisionItem;

var isActionOrDecisionList = function isActionOrDecisionList(node) {
...
exports.isActionOrDecisionList = isActionOrDecisionList;

var isActionOrDecisionItem = function isActionOrDecisionItem(node) {
...
exports.isActionOrDecisionItem = isActionOrDecisionItem;

var isInsideTask = function isInsideTask(state) {
  var taskItem = state.schema.nodes.taskItem;
  return (0, _prosemirrorUtils.hasParentNodeOfType)([taskItem])(state.selection);
};

exports.isInsideTask = isInsideTask;

var isInsideDecision = function isInsideDecision(state) {
  var decisionItem = state.schema.nodes.decisionItem;
  return (0, _prosemirrorUtils.hasParentNodeOfType)([decisionItem])(state.selection);
};

exports.isInsideDecision = isInsideDecision;
...
var getBlockRange = function getBlockRange($from, $to) {
...
var getCurrentIndentLevel = function getCurrentIndentLevel(selection) {
...
exports.getCurrentIndentLevel = getCurrentIndentLevel;

var getTaskItemIndex = function getTaskItemIndex(state) {
  ...
  var itemAtPos = (0, _prosemirrorUtils.findParentNodeClosestToPos)($pos, isTaskList);
...
exports.getTaskItemIndex = getTaskItemIndex;

var walkOut = function walkOut($startPos) {
...
exports.walkOut = walkOut;

var subtreeHeight = function subtreeHeight($from, $to, types) {
...
var isEmptyTaskDecision = function isEmptyTaskDecision(state) {
...
exports.isEmptyTaskDecision = isEmptyTaskDecision;

var liftBlock = function liftBlock(tr, $from, $to) {
  var blockRange = getBlockRange($from, $to);
  ...
  var target = (0, _prosemirrorTransform.liftTarget)(blockRange);
