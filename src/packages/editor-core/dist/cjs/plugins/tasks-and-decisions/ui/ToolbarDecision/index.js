...
exports.default = exports.ToolbarDecision = void 0;
...
var ToolbarDecision = /*#__PURE__*/function (_PureComponent) {
  (0, _inherits2.default)(ToolbarDecision, _PureComponent);
  ...
  function ToolbarDecision() {
    ...
    (0, _classCallCheck2.default)(this, ToolbarDecision);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleInsertDecision", function () {
      ...
      (0, _commands.insertTaskDecisionCommand)('decisionList')(editorView.state, editorView.dispatch);
      return true;
    });
    return _this;
  }

  (0, _createClass2.default)(ToolbarDecision, [{
    key: "render",
...
var _default = (0, _reactIntlNext.injectIntl)(ToolbarDecision);
