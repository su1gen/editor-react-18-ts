...
var MediaPluginStateImplementation = /*#__PURE__*/function () {
  function MediaPluginStateImplementation(_state, options, mediaOptions, _dispatch) {
    ...
    (0, _defineProperty2.default)(this, "splitMediaGroup", function () {
      return (0, _mediaCommon.splitMediaGroup)(_this.view);
    });
    ...
    (0, _defineProperty2.default)(this, "getInputMethod", function (pickerType) {
      switch (pickerType) {
        ...
        case 'dropzone':
          return _types.INPUT_METHOD.DRAG_AND_DROP;
      }

      return;
    });
    (0, _defineProperty2.default)(this, "updateMediaNodeAttrs", function (id, attrs, isMediaSingle) {
      var view = _this.view;
      ...
      return (0, helpers.updateMediaNodeAttrs)(id, attrs, isMediaSingle)(view.state, view.dispatch);
    });
    ...
    (0, _defineProperty2.default)(this, "removeSelectedMediaContainer", function () {
      ...
      (0, _mediaCommon.removeMediaNode)(view, selectedNode.firstChild, function () {
        return from + 1;
      });
      return true;
    });
...
exports.MediaPluginStateImplementation = MediaPluginStateImplementation;
  ...
  return new _safePlugin.SafePlugin({
    ...
    props: {
      ...
      handleClick: function handleClick(_editorView, _pos, event) {
        ...
        var clickedInsideCaptionPlaceholder = (_event$target = event.target) === null || _event$target === void 0 ? void 0 : _event$target.closest("[data-id=\"".concat(_CaptionPlaceholder.CAPTION_PLACEHOLDER_ID, "\"]")); // Workaround for Chrome given a regression introduced in prosemirror-view@1.18.6
