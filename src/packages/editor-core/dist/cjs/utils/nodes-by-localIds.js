...
exports.findNodePosByLocalIds = exports.findNodePosByFragmentLocalIds = void 0;

var findNodePosByLocalIds = function findNodePosByLocalIds(state, ids) {
...
exports.findNodePosByLocalIds = findNodePosByLocalIds;

var findNodePosByFragmentLocalIds = function findNodePosByFragmentLocalIds(state, ids) {
  if (ids.length === 0) {
    return [];
  }
...
exports.findNodePosByFragmentLocalIds = findNodePosByFragmentLocalIds;