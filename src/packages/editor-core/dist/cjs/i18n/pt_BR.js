...
var _default = {
  ...
  'fabric.editor.extension.confirmDeleteLinkedModalMessage': 'A remoção desta extensão vai interromper o que estiver conectado a ela.',
  'fabric.editor.extension.confirmDeleteLinkedModalOKButton': 'Remover extensão',
  ...
  'fabric.editor.searchResults': '{itemsLength, plural, one {{itemsLength,number} resultado disponível da pesquisa} other {{itemsLength,number} resultados disponíveis da pesquisa}}',
